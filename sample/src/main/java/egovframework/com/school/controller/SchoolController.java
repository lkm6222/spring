...
//	}
	...
	@RequestMapping("/school/getSchoolInfo.do")
	public ModelAndView getSchoolInfo(@RequestParam HashMap<String, Object> paraMap) {
		ModelAndView mv = new ModelAndView();
		
		int schoolIdx = Integer.parseInt(paraMap.get("schoolId").toString());
		HashMap<String,Object> schoolInfo = schoolService.selectSchoolInfo(schoolIdx);
	...
	public ModelAndView insertSchoolInfo(@RequestParam HashMap<String, Object> paraMap) {
		...
		int resultChk = 0;
		resultChk = schoolService.insertSchoolInfo(paraMap);
	...
	public ModelAndView deleteSchoolInfo(@RequestParam HashMap<String, Object> paraMap) {
		...
		int resultChk = 0;
		resultChk = schoolService.deleteSchoolInfo(paraMap);
