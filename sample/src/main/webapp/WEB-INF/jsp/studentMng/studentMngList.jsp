...
<body>
	...
	<table style="border: 1px solid #444444;">	
		...
		<tbody id="bodyList">
<%-- 		<c:forEach var="student" items="${studentMngList }">
			<tr>
				<td style="border: 1px solid #444444">${student.rNum }</td>
				<td style="border: 1px solid #444444">${student.studentName }</td>
				<td style="border: 1px solid #444444">${student.schoolName }</td>
				<td style="border: 1px solid #444444">${student.studentGraduateYn }</td>
			</tr>
		</c:forEach> --%>
		</tbody>
	</table>
